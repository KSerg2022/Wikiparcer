...
@calc_time
def main(start_article, finish_article, requests_per_minute, links_per_page):
    """Main controller"""
    path = PathFinder(start_article, finish_article, requests_per_minute, links_per_page)
